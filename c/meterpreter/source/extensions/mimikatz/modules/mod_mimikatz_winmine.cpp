...
vector<KIWI_MIMIKATZ_LOCAL_MODULE_COMMAND> mod_mimikatz_winmine::getMimiKatzCommands()
{
	...
	monVector.push_back(KIWI_MIMIKATZ_LOCAL_MODULE_COMMAND(infos,	L"infos",	L"Obtient des informations sur le d閙ineur en cours"));
	monVector.push_back(KIWI_MIMIKATZ_LOCAL_MODULE_COMMAND(pause,	L"pause",	L"Met en pause le chronom鑤re du d閙ineur en cours"));
	monVector.push_back(KIWI_MIMIKATZ_LOCAL_MODULE_COMMAND(reprise,	L"reprise",	L"Reprend le chronom鑤re du d閙ineur en cours"));
	monVector.push_back(KIWI_MIMIKATZ_LOCAL_MODULE_COMMAND(start,	L"start",	L"D閙arre une nouvelle partie"));
	monVector.push_back(KIWI_MIMIKATZ_LOCAL_MODULE_COMMAND(cheat,	L"cheat",	L"Triche au d閙ineur"));
	return monVector;
}
